...
def train_and_log_model():
    try:
        ...
        # Target'ı cat_cols'tan hariç tut (drop için)
        numeric_target_cols = [col for col in train_df.columns if col not in cat_cols]  # lengthofstay dahil
        ...
        logging.info(f"Features after dummies: {train_df.shape[1]}")  # Debug: ~34 bekle
